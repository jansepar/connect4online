# Django settings for connect4online project.
...
SECRET_KEY = '#vpzr4&yq8db%()4ywzo8zuu_#(k59d6uis$0vtq9vndl5&nao'
...
MIDDLEWARE_CLASSES = (
	...
	'connect4online.facebookmiddleware.SetFacebookAccessToken'
)
